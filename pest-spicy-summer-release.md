...
In addition, just like regular coverage, you may enforce a `--min` type coverage percentage. For example, if you run `--type-coverage --min=100`, you will see the following output:
